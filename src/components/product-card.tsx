        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              <Button size="lg" className="flex-1 h-16 sm:h-11" onClick={handleDialogAddToCart} disabled={!canPurchase}>Add to cart</Button>
              <Button size="lg" className="flex-1 h-16 sm:h-11 bg-accent text-accent-foreground hover:bg-accent/90" asChild>
